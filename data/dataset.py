...
def get_input_prompt(
    ...
    You have 40 turns. Take a deep breath. You can do anything.
    """


_KEEP_COMBOS = (("easy", "easy"), ("hard", "hard"))  # ("easy", "easy"), 
            ...
            samples_list.append(
                Sample(
                    ...
                    input=get_input_prompt(
                        ...
                        False,  # metadata["noticing_hints"],
                        False  # metadata["execution_hints"],
                    ),
